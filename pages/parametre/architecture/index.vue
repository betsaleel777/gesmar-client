...
import ListePavillon from '~/components/architecture/batiment/ListePavillon.vue'
import ListePavillonArchive from '~/components/architecture/batiment/ListePavillonArchive.vue'
