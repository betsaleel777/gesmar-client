      ...
      <div v-if="!$fetchState.pending" class="content-body">
        <div id="printable" class="card card-invoice">
          <div class="card-header align-items-center">
            <img src="https://via.placeholder.com/500/637382/fff" class="img-fluid" width="125" height="125" alt="logo sgmt" />
            <span class="tx-26 tx-bold flex-grow-1 text-center text-uppercase">société de gestion du grand marché de treichville</span>
          </div>
          <!-- card-header -->
          <div class="card-body">
            <div class="row">
              <div class="col-sm-12 tx-center d-md-block align-content-center">
                <span><h3 class="tx-normal mg-b-10 tx-spacing--2 text-uppercase">Facture de premier décompte</h3></span>
              </div>
              <!-- col -->
              <div class="col-sm-8 col-lg-9 mg-t-40 mg-sm-t-0 mg-md-t-40">
                ...
                <p v-if="facture.personne.email" class="mb-0">Email: youremail@companyname.com</p>
              </div>
              <!-- col -->
              <div class="col-sm-4 col-lg-3 mg-t-40">
            ...
            <div class="table-responsive mg-t-25">
              <table class="table table-invoice bd-b">
                <thead>
                  <tr>
                    <th class="wd-20p">Dénomination</th>
