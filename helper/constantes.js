...
const NATURES_PAIEMENT = ['Espece', 'Cheque']
const LINKS = Object.freeze({
  demande: 'Demandes à traiter',
  prospect: 'Prospects',
  client: 'Clients',
  contrat: 'Contrats validés',
  abonnement: 'Abonnements',
  ordonnancements: 'Ordres de recette',
  annexe: 'Factures annexe',
  equipement: "Factures d'équipements",
  initiale: 'Factures PDP',
  loyer: 'Factures de loyer',
  soldee: 'Factures soldées',
  bordereaux: 'Bordereaux',
  commercial: 'Commerciaux',
  ouverture: 'Ouvertures de caisse',
  'point-caisse': 'Points de caisse',
  ...
  'service-annexe': 'Services Annexe',
  'type-equipement': "Types d'équipement",
  'type-emplacement': "Types d'emplacements",
  guichet: 'Guichets',
  compte: 'Comptes',
  banque: 'Banques',
  caissier: 'Caissiers',
