      ...
      <div class="form-group">
        ...
        <div class="custom-control custom-checkbox">
          ...
          <label class="custom-control-label" for="customCheck2"
            >Email a digest summary of vulnerabilities</label
          >
        </div>
      </div>
      <!-- form-group -->
      ...
      <div class="form-group">
        ...
        <ul class="list-group list-group-notification">
          ...
          <li class="list-group-item">
            ...
            <div class="custom-control custom-switch">
              <input id="customSwitch2" type="checkbox" class="custom-control-input" />
          ...
          <li class="list-group-item">
            ...
            <div class="custom-control custom-switch">
              <input id="customSwitch3" type="checkbox" class="custom-control-input" />
          ...
          <li class="list-group-item">
            ...
            <div class="custom-control custom-switch">
              <input id="customSwitch4" type="checkbox" class="custom-control-input" />
          ...
          <li class="list-group-item">
            ...
            <div class="custom-control custom-switch">
              <input id="customSwitch5" type="checkbox" class="custom-control-input" />
